"""Post-optimization validation engine: independently re-checks the produced
schedule against energy balance, effective-solar, battery, and directive
constraints before it is returned to the client. Acts as a defense-in-depth
sanity check on top of the optimizer's own constraints.
"""
...
def validate_schedule(
    ...
    plan_by_hour = {r.hour for r in plan}
